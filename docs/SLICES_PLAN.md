...
> Canonical progress tracker **for the on-device offline MVP**. **Read this + [`ARCHITECTURE.md`](./ARCHITECTURE.md) + [`PROJECT_RULES.md`](../PROJECT_RULES.md) first** in every new chat/tab.
...
>
> **Cloud MVP slices** live in [`SLICES_PLAN_CLOUD.md`](./SLICES_PLAN_CLOUD.md) (+ [`ARCHITECTURE_CLOUD.md`](./ARCHITECTURE_CLOUD.md)) — keep this file for on-device work.
