...
export const Colors = {
  light: {
    ...
    statusDoneBg: '#bceed0',
    statusDoneFg: '#13422e',
    statusProcessingBg: '#cce3f1',
    statusProcessingFg: '#344a55',
    statusQueuedBg: '#f5e6d3',
    statusQueuedFg: '#8a5a2b',
    statusFailedBg: '#ffdad6',
    statusFailedFg: '#93000a',
  },
  dark: {
    text: '#f3f0ec',
    background: '#1c1c19',
    ...
    statusDoneBg: '#214f39',
    statusDoneFg: '#a0d2b5',
    statusProcessingBg: '#344a55',
    statusProcessingFg: '#cce3f1',
    statusQueuedBg: '#5c4a2e',
    statusQueuedFg: '#f0c674',
    statusFailedBg: '#5c2a2a',
    statusFailedFg: '#ffb4ab',
  },
} as const;
